    ...
    <div v-loading="qLoading" style="line-height:1.8">
        <div v-if="qType == 1 || qType == 2 || qType == 3 || qType == 4 || qType == 5">
            ...
            <div v-else-if="qType == 4">
                ...
                <div v-if="answer.contentArray !== null">
                    <el-form-item :label="item.prefix" :key="item.prefix" v-for="item in question.items"
                        ...
                        <el-input v-model="answer.contentArray[item.prefix - 1]" disabled />
                    </el-form-item>
                </div>
            </div>
            <div v-else-if="qType == 5">
                <div class="q-title" v-html="question.title" />
                <div>
                    <el-input v-model="answer.content" type="textarea" rows="5" disabled></el-input>
                </div>
            </div>
            ...
            <div class="question-answer-show-item">
                ...
                <span v-if="qType == 1 || qType == 2 || qType == 5" v-html="question.correct"
